...
{//try with resources start
            ...
            if (inputStream != null)
            {
                ...
                // create our filename
                String uploadPath = "C:\\Users\\rach2\\Desktop\\TTA\\Project stuff\\Test Code\\LibraryManagementSystem\\build\\web\\images\\bookimages\\BookImageForBID"+request.getParameter("bid")+".jpg";
