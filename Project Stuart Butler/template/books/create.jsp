            ...
            <div id="header">
                ...
                <nav id="nav">
                    <ul>
                        ...
                        <li class="current"><a href="create.jsp">Add Book</a></li>
                ...
                <div class="container">
                    <div id="content">
                        ...
                        <center>
                            ...
                            <form name="fileform" action="<%=request.getContextPath()%>/BookUpload" method="post" enctype="multipart/form-data">
                                <table border="1" cellpadding="15">
                                    <tr>
                                        <td>Book ID: <input type="text" name="BookID"/></td>
                                    </tr>
                                    <tr>
                                        <td>Book Title: <input type="text" name="BookTitle"/></td>
                                    </tr>
                                    <tr>
                                        <td >Author: <input type="text" name="BookAuthor"/></td>
                                    </tr>
                                    <tr>
                                        <td >Book Cover: 
                                            <input type="file" size="50" name="BookImage" id="custom-upload"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Number of Copies <input type="number" name="BookCopiesIn"/></td>
                                    </tr>
                                    <tr>
                                        <td>Copies Issued <input type="number" name="BookCopiesOut"/></td>
                                    </tr>
                                    <tr>
